	...
	<aside class="main-sidebar">
		...
		<section class="sidebar">
			...
			<ul class="sidebar-menu">
                ...
                <li class="nav-click xwbHide <#if pageName == "index">active</#if>" ><a href="${request.contextPath}/"><i class="fa fa-circle-o text-aqua"></i><span>${I18n.job_dashboard_name}</span></a></li>
                ...
                <li class="nav-click xwbHide <#if pageName == "jobgroup">active</#if>" ><a href="${request.contextPath}/jobgroup"><i class="fa fa-circle-o text-red"></i><span>${I18n.jobgroup_name}</span></a></li>
                ...
                <li class="nav-click manager xwbHide <#if pageName == "user">active</#if>" ><a href="${request.contextPath}/users"><i class="fa fa-circle-o text-purple"></i><span>${I18n.job_user}</span></a></li>
                <li class="nav-click manager xwbHide <#if pageName == "role">active</#if>" ><a href="${request.contextPath}/roles"><i class="fa fa-circle-o text-fuchsia"></i><span>${I18n.job_role}</span></a></li>
                <li class="nav-click manager xwbHide <#if pageName == "resources">active</#if>" ><a href="${request.contextPath}/resources"><i class="fa fa-circle-o text-lime"></i><span>${I18n.job_resources}</span></a></li>
			</ul>
		</section>
		<!-- /.sidebar -->
	</aside>
